...
<div id="dashboard-rss">
	...
	<div class="dash-col dash-left">	
		...
		<h2><?php _e( 'Latest Updates from Bamboo:', 'bamboo' ); ?></h2>
		...
		// rss cache time
		add_filter( 'wp_feed_cache_transient_lifetime', create_function('$a', 'return 36;') );
		
		
		include_once( ABSPATH . WPINC . '/feed.php' );
		
		// Get a SimplePie feed object from the specified feed source.
		$rss = fetch_feed( 'http://feeds.feedburner.com/raison/bamboo/' );
